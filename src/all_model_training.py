def all_model_training():
    ...
    logging.info("Tuning the DummyRegressor Model")
    try:
        ...
        MAE_DR = mean_absolute_error(y_test,y_pred)
        joblib.dump(MAE_DR,MODEL_EVAL/'dummy_regression_performance.joblib')
    except Exception as ex:
        logging.error(f"An error occurred while training and testing the DummyRegressor")
        raise
    logging.info("DummyRegressor completed")
    logging.info("Tuning the HistGradientBoosting Regressor Model")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'histgradientboosting_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'histgradientboosting_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'histgradientboosting_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing the HistGradientBoosting Regressor: {ex}')
        raise
    logging.info('Training and testing of HistGradientBoosting Regressor completed')
    logging.info("Tuning the Light GBM Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        logging.error(f'An error occurred while training and testing Light GBM Regressor: {ex}')
        raise
    logging.info("Training and testing for Light GBM Regressor is completed")
    logging.info("Training and testing XGBoost Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'xgboost_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'xgboost_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'xgboost_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing XGBoost Regressor: {ex}')
        raise
    logging.info("Training and testing for XGBoost Regressor is completed")
    logging.info("Training and testing MLP Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'mlp_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'mlp_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'mlp_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing MLP Regressor: {ex}')
        raise
    logging.info("Training and testing for MLP Regressor is completed")
    logging.info("Training and testing Lasso Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'lasso_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'lasso_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'lasso_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing Lasso Regression: {ex}')
        raise
    logging.info("Training and testing for Lasso Regressor is completed")
    logging.info("Training and testing Ridge Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'ridge_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'ridge_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'ridge_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing Ridge Regression: {ex}')
        raise
    logging.info("Training and testing for Ridge Regressor is completed")
    logging.info("Training and testing Elastic Net Regressor")
    try:
        def stage1(trial):
            cv=GroupTimeSplit(
                group_column='gp_id',
        ...
        joblib.dump(best_param,MODEL_PARAMS/'elastic_net_best_param.joblib')
        joblib.dump(best_score,MODEL_EVAL/'elastic_net_best_score.joblib')
        joblib.dump(total_time,MODEL_RUN_TIME/'elastic_net_run_time.joblib')
        ...
        logging.error(f'An error occurred while training and testing Elastic Net Regression: {ex}')
        raise
    logging.info("Training and testing for Elastic Net Regressor is completed")
    logging.info("Loading the performance of the all the models")
    try:
        ...
        pd.to_csv(df_performance,MODEL_PERFORMANCE/'Model_Performance.csv',index=False)
        print(df_performance)
    except Exception as ex:
        logging.error(f'An error occurred while loading the performance table')
